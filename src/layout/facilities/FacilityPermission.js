                  ...
                  <Text style={{fontWeight: 'bold'}}>(a) Use of This Service. </Text>
                    ...
                    <Text style={[styles.text, { marginTop: 0 }]}>
                      <Text style={{ fontWeight: 'bold' }}>(b) Providing Services. </Text>
                        BookSmart™ will never: direct or control your interaction(s) with any I/C regarding their Service Application; take any active role in any I/C’s provision of services pursuant to your Service Request; direct Your acts or omissions in connection with any I/C; or direct any I/C to report to any facility at any given time, for any given shift, or for any set period of time. BookSmart™ simply makes Service Requests visible to I/Cs, and You retain total and complete control as to when, if ever, You post a shift or otherwise use BookSmart™. You acknowledge and agree that each I/C retains total and complete autonomy to provide other services to other entities or to otherwise engage in other business activities. 
                    </Text> 
