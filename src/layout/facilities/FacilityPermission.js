          ...
          <Hyperlink linkDefault={true}>
            <View style={styles.permission}>
              ...
              <View style={styles.titleBar}>
                ...
                <Text style={[styles.text, { marginBottom: 0 }]}><Text style={{fontWeight: 'bold'}}>(a) Payment Terms. </Text>For each Completed Requested Service that an I/C performs, BOOKSMART™ will receive from the Customer the I/C's hourly Fees plus applicable Rates and/or Fees as such:</Text>
