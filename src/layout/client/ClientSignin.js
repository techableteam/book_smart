      ...
      >
        <View style={styles.modal}>
          ...
          <View style={styles.intro}>
            ...
            <Text style={constStyles.loginSmallText}>Let your licensure and certifications {'\n'}pay off. Get the money you deserve by signing up and becoming a freelance clinician today!</Text>
