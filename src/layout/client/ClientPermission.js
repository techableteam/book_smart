                ...
                <Hyperlink linkDefault={true}>
                    <View style={styles.permission}>
                        ...
                        <View style={styles.titleBar}>
                            ...
                            <Text style={{ textAlign: 'left', fontSize: 14, fontWeight: 'normal', color: 'black' }}>*Note: BookSmart™ is committed to helping our I/Cs work through any challenges they may face with regards to canceling a shift. If you feel your situation was unavoidable and you can provide written documentation such as a legible doctor’s note or police report to support this cancellation, we will consider lifting your suspension on a case-by-case basis.</Text>
