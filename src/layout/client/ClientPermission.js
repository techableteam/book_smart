                ...
                <Hyperlink linkDefault={true}>
                    <View style={styles.permission}>
                        ...
                        <View style={styles.titleBar}>
                            ...
                            <Text style={[styles.text, {marginTop: 0, marginBottom: 0}]}><Text style={{fontWeight: 'bold'}}>(e) Service Fee. </Text>By accessing/using BOOKSMART™ you consent and agree to these terms:</Text>
